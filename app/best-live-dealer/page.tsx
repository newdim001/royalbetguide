...
export const metadata = {
  title: "Best Live Dealer Casinos 2026",
  description: "Experience real casino action from home. Compare the best live dealer casinos with real dealers.",
};
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
      <div className="mb-10 text-center">
        ...
        <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-corg-600">Best Live Dealer Casinos 2026</h1>
        <p className="mt-2 text-slate-500">Experience real casino action from home. Compare the best live dealer casinos with real dealers.</p>
      </div>
