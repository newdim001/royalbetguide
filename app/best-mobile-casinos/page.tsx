...
export const metadata = {
  title: "Best Mobile Casinos 2026",
  description: "Play on the go at the best mobile casinos. Compare mobile-optimized platforms and exclusive bonuses.",
};
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
      <div className="mb-10 text-center">
        ...
        <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-corg-600">Best Mobile Casinos 2026</h1>
        <p className="mt-2 text-slate-500">Play on the go at the best mobile casinos. Compare mobile-optimized platforms and exclusive bonuses.</p>
      </div>
