...
const slug = "the-bone-riders";
const demoUrl = getDemoUrl(slug);
const displayName = "The Bone Riders";

export const metadata = {
  title: "The Bone Riders Slot 2026 — Review, RTP & Free Demo",
  description: "Play The Bone Riders free demo by Pragmatic Play. Viking slot with 40 paylines.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/the-bone-riders/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/the-bone-riders/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">A Viking-themed 5x4 slot with 40 paylines. Viking raid free spins feature with shield multipliers. The epic Norse warrior theme appeals to players who enjoy action-packed slots.</p>
        </div>
        ...
        <div className="card-light mb-8">
          ...
          <div className="mt-4 space-y-2 text-sm text-slate-700">
            ...
            <p><strong>Theme:</strong> Vikings</p>
          </div>
        </div>
