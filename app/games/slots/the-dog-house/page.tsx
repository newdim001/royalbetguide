...
const slug = "the-dog-house";
const demoUrl = getDemoUrl(slug);
const displayName = "The Dog House";

export const metadata = {
  title: "The Dog House Slot 2026 — Review, RTP & Free Demo",
  description: "Play The Dog House free demo by Pragmatic Play. Pragmatic Play's charming canine-themed slot.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/the-dog-house/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/the-dog-house/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">Pragmatic Play's charming canine-themed slot features a 5x3 grid with 20 paylines, sticky wilds with multipliers up to 3x in free spins, and a max win of 6,750x. The lovable dog characters and playful soundtrack make this an entertaining choice for casual slot players.</p>
        </div>
