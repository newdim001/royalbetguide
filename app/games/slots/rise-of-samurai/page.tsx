...
const slug = "rise-of-samurai";
const demoUrl = getDemoUrl(slug);
const displayName = "Rise of Samurai";

export const metadata = {
  title: "Rise of Samurai Slot 2026 — Review, RTP & Free Demo",
  description: "Play Rise of Samurai free demo by Pragmatic Play. Feudal Japan warrior slot.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/rise-of-samurai/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/rise-of-samurai/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">A feudal Japan themed 5x4 slot with 30 paylines. Honor free spins with warrior wilds. The samurai theme immerses players in ancient Japanese warrior culture with stunning artwork.</p>
        </div>
