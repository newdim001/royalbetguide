...
const slug = "5-dragons";
const demoUrl = getDemoUrl(slug);
const displayName = "5 Dragons";

export const metadata = {
  title: "5 Dragons Slot 2026 — Review, RTP & Free Demo",
  description: "Play 5 Dragons free demo by Pragmatic Play. Asian slot with 243 ways to win.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/5-dragons/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/5-dragons/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">A classic Asian-themed 5-reel slot with 243 ways to win. Features free spins with three different bonus options, each offering different volatility levels. The dragon theme is beautifully rendered with traditional artwork.</p>
        </div>
