...
const slug = "golden-tale";
const demoUrl = getDemoUrl(slug);
const displayName = "Golden Tale";

export const metadata = {
  title: "Golden Tale Slot 2026 — Review, RTP & Free Demo",
  description: "Play Golden Tale free demo by Pragmatic Play. Fairy tale slot with expanding symbols.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/golden-tale/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/golden-tale/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">A fairy tale inspired 5x4 slot with 20 paylines. Book-themed expanding symbol free spins feature with big win potential. The storybook theme appeals to players who enjoy narrative-driven slots.</p>
        </div>
