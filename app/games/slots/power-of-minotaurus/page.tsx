...
const slug = "power-of-minotaurus";
const demoUrl = getDemoUrl(slug);
const displayName = "Power of Minotaurus";

export const metadata = {
  title: "Power of Minotaurus Slot 2026 — Review, RTP & Free Demo",
  description: "Play Power of Minotaurus free demo by Pragmatic Play. Greek mythology scatter slot.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/power-of-minotaurus/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/power-of-minotaurus/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">A Greek mythology 6x5 scatter-pays slot in the same style as Gates of Olympus. Minotaurus theme with tumbling reels and multipliers up to 500x. Max win 5,000x.</p>
        </div>
