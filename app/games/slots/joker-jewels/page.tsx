...
const slug = "joker-jewels";
const demoUrl = getDemoUrl(slug);
const displayName = "Joker Jewels";

export const metadata = {
  title: "Joker Jewels Slot 2026 — Review, RTP & Free Demo",
  description: "Play Joker Jewels free demo by Pragmatic Play. Classic slot with wilds.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/joker-jewels/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/joker-jewels/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">A classic 5-reel, 5-payline slot with a simple joker theme. Features wild substitutions and scatter wins. Ideal for low-stakes casual play. The straightforward mechanics make it perfect for beginners.</p>
        </div>
