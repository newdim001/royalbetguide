...
const slug = "caishang-cash-pots";
const demoUrl = getDemoUrl(slug);
const displayName = "Caishang Cash Pots";

export const metadata = {
  title: "Caishang Cash Pots Slot 2026 — Review, RTP & Free Demo",
  description: "Play Caishang Cash Pots free demo by Pragmatic Play. New Year themed cluster slot.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/caishang-cash-pots/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/caishang-cash-pots/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">A Chinese New Year themed 6x5 cluster-pays slot with tumbling reels. Cash pot feature with progressive jackpots. Max win 5,000x. The festive theme celebrates prosperity and good fortune.</p>
        </div>
        ...
        <div className="card-light mb-8">
          ...
          <div className="mt-4 space-y-2 text-sm text-slate-700">
            ...
            <p><strong>Theme:</strong> Asian New Year</p>
          </div>
        </div>
