...
const slug = "fortune-pots";
const demoUrl = getDemoUrl(slug);
const displayName = "Fortune Pots";

export const metadata = {
  title: "Fortune Pots Slot 2026 — Review, RTP & Free Demo",
  description: "Play Fortune Pots free demo by Pragmatic Play. Asian prosperity slot.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/fortune-pots/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/fortune-pots/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">An Asian prosperity themed slot with triple jackpot system. Golden pots trigger respins with cash values. The fortune-themed visuals and jackpot potential make this an engaging choice.</p>
        </div>
        ...
        <div className="card-light mb-8">
          ...
          <div className="mt-4 space-y-2 text-sm text-slate-700">
            ...
            <p><strong>Theme:</strong> Asian Prosperity</p>
          </div>
        </div>
