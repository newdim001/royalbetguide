...
const slug = "pirate-silver";
const demoUrl = getDemoUrl(slug);
const displayName = "Pirate Silver";

export const metadata = {
  title: "Pirate Silver Slot 2026 — Review, RTP & Free Demo",
  description: "Play Pirate Silver free demo by Pragmatic Play. High seas slot with treasure.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/pirate-silver/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/pirate-silver/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">A high-seas adventure 5x3 slot with 10 paylines. Treasure chest bonus round and free spins with expanding wilds. The pirate adventure theme is brought to life with detailed ship and island graphics.</p>
        </div>
        ...
        <div className="card-light mb-8">
          ...
          <div className="mt-4 space-y-2 text-sm text-slate-700">
            ...
            <p><strong>Theme:</strong> Pirates</p>
          </div>
        </div>
