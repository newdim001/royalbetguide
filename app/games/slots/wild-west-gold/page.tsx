...
const slug = "wild-west-gold";
const demoUrl = getDemoUrl(slug);
const displayName = "Wild West Gold";

export const metadata = {
  title: "Wild West Gold Slot 2026 — Review, RTP & Free Demo",
  description: "Play Wild West Gold free demo by Pragmatic Play. Western slot with sticky wilds.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/wild-west-gold/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/wild-west-gold/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">A western-themed 5x3 slot with 10 paylines. Features sticky wilds with multipliers during free spins and a money collect bonus with three jackpot levels. Max win 6,650x. Saddle up for wild west adventures.</p>
        </div>
        ...
        <div className="card-light mb-8">
          ...
          <div className="mt-4 space-y-2 text-sm text-slate-700">
            ...
            <p><strong>Theme:</strong> Western</p>
          </div>
        </div>
