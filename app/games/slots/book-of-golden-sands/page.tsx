...
const slug = "book-of-golden-sands";
const demoUrl = getDemoUrl(slug);
const displayName = "Book of Golden Sands";

export const metadata = {
  title: "Book of Golden Sands Slot 2026 — Review, RTP & Free Demo",
  description: "Play Book of Golden Sands free demo by Pragmatic Play. Egyptian book slot.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/book-of-golden-sands/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/book-of-golden-sands/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">An Egyptian book-themed slot with 5 reels and 10 paylines. Expanding symbol free spins feature similar to classic book slots. Max win 5,000x. The golden sands theme captures the mystery of ancient Egypt.</p>
        </div>
        ...
        <div className="card-light mb-8">
          ...
          <div className="mt-4 space-y-2 text-sm text-slate-700">
            ...
            <p><strong>Theme:</strong> Egyptian</p>
          </div>
        </div>
