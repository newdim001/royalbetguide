...
const displayName = "Dragon Tiger";

export const metadata = {
  title: "Dragon Tiger Slot 2026 — Review, RTP & Free Demo",
  description: "Play Dragon Tiger free demo by Pragmatic Play. Simple 3-reel slot.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/dragon-tiger/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/dragon-tiger/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">A simple 3-reel slot inspired by the Dragon Tiger casino card game. Two paylines with straightforward gameplay. Perfect for players who enjoy fast, simple slot action without complex bonus features.</p>
        </div>
