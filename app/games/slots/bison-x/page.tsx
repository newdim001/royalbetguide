...
const displayName = "Bison X";

export const metadata = {
  title: "Bison X Slot 2026 — Review, RTP & Free Demo",
  description: "Play Bison X free demo by Pragmatic Play. Prehistoric scatter-pays slot.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/bison-x/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/bison-x/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">A prehistoric-themed 6x5 slot with scatter pays and tumbling reels. Multiplier symbols accumulate during free spins for massive win potential. Max win 5,000x. The ice age theme brings prehistoric beasts to life.</p>
        </div>
        ...
        <div className="card-light mb-8">
          ...
          <div className="mt-4 space-y-2 text-sm text-slate-700">
            ...
            <p><strong>Theme:</strong> Prehistoric</p>
          </div>
        </div>
