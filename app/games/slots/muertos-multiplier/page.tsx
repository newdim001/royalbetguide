...
const slug = "muertos-multiplier";
const demoUrl = getDemoUrl(slug);
const displayName = "Muertos Multiplier";

export const metadata = {
  title: "Muertos Multiplier Slot 2026 — Review, RTP & Free Demo",
  description: "Play Muertos Multiplier free demo by Pragmatic Play. Day of the Dead slot.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/muertos-multiplier/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/muertos-multiplier/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">A Day of the Dead themed 5x3 slot with 10 paylines. Multiplier symbols that can reach up to 100x during free spins. The vibrant calavera artwork makes this visually stunning.</p>
        </div>
        ...
        <div className="card-light mb-8">
          ...
          <div className="mt-4 space-y-2 text-sm text-slate-700">
            ...
            <p><strong>Theme:</strong> Day of the Dead</p>
          </div>
        </div>
