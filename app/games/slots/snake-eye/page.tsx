...
const slug = "snake-eye";
const demoUrl = getDemoUrl(slug);
const displayName = "Snake Eye";

export const metadata = {
  title: "Snake Eye Slot 2026 — Review, RTP & Free Demo",
  description: "Play Snake Eye free demo by Pragmatic Play. Serpent-themed slot.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/snake-eye/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/snake-eye/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">A mysterious serpent-themed 5x3 slot with 10 paylines. Snake multiplier wilds creep across the reels during free spins. The hypnotic snake theme creates a tense, thrilling atmosphere.</p>
        </div>
        ...
        <div className="card-light mb-8">
          ...
          <div className="mt-4 space-y-2 text-sm text-slate-700">
            ...
            <p><strong>Theme:</strong> Serpent</p>
          </div>
        </div>
