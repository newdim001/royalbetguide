...
const slug = "pirates-pots";
const demoUrl = getDemoUrl(slug);
const displayName = "Pirate Pots";

export const metadata = {
  title: "Pirate Pots Slot 2026 — Review, RTP & Free Demo",
  description: "Play Pirate Pots free demo by Pragmatic Play. Swashbuckling slot with jackpots.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/pirates-pots/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/pirates-pots/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">A swashbuckling 5x3 slot with 25 paylines. Three jackpot levels won through the money wheel bonus. The pirate theme features treasure maps, gold coins, and adventurous sea-faring graphics.</p>
        </div>
