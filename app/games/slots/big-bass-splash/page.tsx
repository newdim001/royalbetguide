...
const slug = "big-bass-splash";
const demoUrl = getDemoUrl(slug);
const displayName = "Big Bass Splash";

export const metadata = {
  title: "Big Bass Splash Slot 2026 — Review, RTP & Free Demo",
  description: "Play Big Bass Splash free demo by Pragmatic Play. Latest Big Bass series slot.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/big-bass-splash/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/big-bass-splash/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">The latest Big Bass series entry with a 5x3 grid and money collect feature. Multiplier values increase with each fisherman wild collected during free spins. Max win 4,000x. A must-play for fishing slot fans.</p>
        </div>
