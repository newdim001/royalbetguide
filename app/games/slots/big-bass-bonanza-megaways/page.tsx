...
const slug = "big-bass-bonanza-megaways";
const demoUrl = getDemoUrl(slug);
const displayName = "Big Bass Bonanza Megaways";

export const metadata = {
  title: "Big Bass Bonanza Megaways Slot 2026 — Review, RTP & Free Demo",
  description: "Play Big Bass Bonanza Megaways free demo by Pragmatic Play. Fishing Megaways slot.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/big-bass-bonanza-megaways/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/big-bass-bonanza-megaways/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">The fishing classic with up to 46,656 ways to win. Money collect feature with increasing multipliers during free spins. Max win 4,000x. The Megaways mechanic adds extra excitement to the beloved Big Bass series.</p>
        </div>
        ...
        <div className="card-light mb-8">
          ...
          <div className="mt-4 space-y-2 text-sm text-slate-700">
            ...
            <p><strong>Theme:</strong> Fishing</p>
          </div>
        </div>
