...
const slug = "chilli-heat";
const demoUrl = getDemoUrl(slug);
const displayName = "Chilli Heat";

export const metadata = {
  title: "Chilli Heat Slot 2026 — Review, RTP & Free Demo",
  description: "Play Chilli Heat free demo by Pragmatic Play. Mexican-themed slot with jackpots.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/chilli-heat/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/chilli-heat/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">A Mexican-themed 5x3 slot with 25 paylines, money respin feature with three jackpots, and free spins. Max win 3,000x. The festive Mexican theme combined with the jackpot feature makes Chilli Heat a popular choice.</p>
        </div>
        ...
        <div className="card-light mb-8">
          ...
          <div className="mt-4 space-y-2 text-sm text-slate-700">
            ...
            <p><strong>Theme:</strong> Mexican</p>
          </div>
        </div>
