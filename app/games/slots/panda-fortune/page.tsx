...
const slug = "panda-fortune";
const demoUrl = getDemoUrl(slug);
const displayName = "Panda Fortune";

export const metadata = {
  title: "Panda Fortune Slot 2026 — Review, RTP & Free Demo",
  description: "Play Panda Fortune free demo by Pragmatic Play. Panda animal slot.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/panda-fortune/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/panda-fortune/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">An adorable panda-themed 5x3 slot with 15 paylines. Bamboo free spins with multiplier wilds. The cute panda characters and serene bamboo forest theme appeal to animal lovers.</p>
        </div>
