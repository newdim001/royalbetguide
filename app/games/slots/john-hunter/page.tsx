...
const slug = "john-hunter";
const demoUrl = getDemoUrl(slug);
const displayName = "John Hunter and the Book of Tut";

export const metadata = {
  title: "John Hunter and the Book of Tut Slot 2026 — Review, RTP & Free Demo",
  description: "Play John Hunter and the Book of Tut free demo by Pragmatic Play. Egyptian adventure slot with expanding symbols.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/john-hunter/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/john-hunter/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">An Egyptian adventure slot with 5 reels and 10 paylines. The expanding symbol mechanic during free spins offers big win potential. Max win 4,720x. John Hunter series is known for its engaging bonus features.</p>
        </div>
        ...
        <div className="card-light mb-8">
          ...
          <div className="mt-4 space-y-2 text-sm text-slate-700">
            ...
            <p><strong>Theme:</strong> Egyptian Adventure</p>
          </div>
        </div>
