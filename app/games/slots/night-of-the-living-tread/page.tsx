...
const slug = "night-of-the-living-tread";
const demoUrl = getDemoUrl(slug);
const displayName = "Night of the Living Tread";

export const metadata = {
  title: "Night of the Living Tread Slot 2026 — Review, RTP & Free Demo",
  description: "Play Night of the Living Tread free demo by Pragmatic Play. Zombie slot with treadmill mechanic.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/night-of-the-living-tread/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/night-of-the-living-tread/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">A zombie-themed slot with a unique treadmill mechanic. Free spins with walking wilds that move across the reels. The innovative mechanic and horror theme create a unique gaming experience.</p>
        </div>
        ...
        <div className="card-light mb-8">
          ...
          <div className="mt-4 space-y-2 text-sm text-slate-700">
            ...
            <p><strong>Theme:</strong> Zombie</p>
          </div>
        </div>
