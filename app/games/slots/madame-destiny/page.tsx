...
const slug = "madame-destiny";
const demoUrl = getDemoUrl(slug);
const displayName = "Madame Destiny";

export const metadata = {
  title: "Madame Destiny Slot 2026 — Review, RTP & Free Demo",
  description: "Play Madame Destiny free demo by Pragmatic Play. Fortune-teller slot with expanding wilds.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/madame-destiny/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/madame-destiny/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">A mystical fortune-teller themed 5x3 slot with 10 paylines. Features expanding wilds during free spins with multipliers up to 15x. Max win 5,000x. The crystal ball theme creates an immersive experience.</p>
        </div>
        ...
        <div className="card-light mb-8">
          ...
          <div className="mt-4 space-y-2 text-sm text-slate-700">
            ...
            <p><strong>Theme:</strong> Mystical</p>
          </div>
        </div>
