...
const slug = "the-greatest-catch";
const demoUrl = getDemoUrl(slug);
const displayName = "The Greatest Catch";

export const metadata = {
  title: "The Greatest Catch Slot 2026 — Review, RTP & Free Demo",
  description: "Play The Greatest Catch free demo by Pragmatic Play. Fishing slot with money collect.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/the-greatest-catch/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/the-greatest-catch/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">A fishing-themed 5x3 slot with 10 paylines. Collect fisherman wilds during free spins with money values. Sequel to Big Bass Bonanza with enhanced features. Max win 5,000x.</p>
        </div>
