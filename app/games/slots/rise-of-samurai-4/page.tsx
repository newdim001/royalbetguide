...
const slug = "rise-of-samurai-4";
const demoUrl = getDemoUrl(slug);
const displayName = "Rise of Samurai 4";

export const metadata = {
  title: "Rise of Samurai 4 Slot 2026 — Review, RTP & Free Demo",
  description: "Play Rise of Samurai 4 free demo by Pragmatic Play. Fourth Samurai series slot.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/rise-of-samurai-4/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/rise-of-samurai-4/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">The fourth installment in the Samurai series with enhanced graphics and a 6x5 grid. New battle bonus round with multiplier potential. The series continues to evolve with each release.</p>
        </div>
        ...
        <div className="card-light mb-8">
          ...
          <div className="mt-4 space-y-2 text-sm text-slate-700">
            ...
            <p><strong>Theme:</strong> Samurai</p>
          </div>
        </div>
