...
const displayName = "Wild Ape";

export const metadata = {
  title: "Wild Ape Slot 2026 — Review, RTP & Free Demo",
  description: "Play Wild Ape free demo by Pragmatic Play. Jungle ape slot.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/wild-ape/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/wild-ape/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">A jungle-themed 5x3 slot with 10 paylines. Ape wilds with multipliers during free spins. The jungle adventure theme featuring a powerful silverback gorilla creates an exciting gaming experience.</p>
        </div>
        ...
        <div className="card-light mb-8">
          ...
          <div className="mt-4 space-y-2 text-sm text-slate-700">
            ...
            <p><strong>Theme:</strong> Jungle</p>
          </div>
        </div>
