...
const slug = "888-dragons";
const demoUrl = getDemoUrl(slug);
const displayName = "888 Dragons";

export const metadata = {
  title: "888 Dragons Slot 2026 — Review, RTP & Free Demo",
  description: "Play 888 Dragons free demo by Pragmatic Play. Asian multi-jackpot slot.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/888-dragons/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/888-dragons/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">An Asian-themed multi-jackpot slot with 5 reels and 8 paylines. Three jackpot tiers won through the dragon bonus round. The number 888 represents prosperity in Chinese culture, adding thematic depth.</p>
        </div>
