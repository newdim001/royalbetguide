...
const slug = "curse-of-the-werewolf";
const demoUrl = getDemoUrl(slug);
const displayName = "Curse of the Werewolf";

export const metadata = {
  title: "Curse of the Werewolf Slot 2026 — Review, RTP & Free Demo",
  description: "Play Curse of the Werewolf free demo by Pragmatic Play. Horror slot with twin-reel mechanic.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/curse-of-the-werewolf/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/curse-of-the-werewolf/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">A horror-themed slot with 5 reels, 10 paylines, and a twin-reel mechanic where matching reels boost wins during free spins. The eerie atmosphere combined with the unique twin-reel feature makes this a standout title.</p>
        </div>
        ...
        <div className="card-light mb-8">
          ...
          <div className="mt-4 space-y-2 text-sm text-slate-700">
            ...
            <p><strong>Theme:</strong> Horror</p>
          </div>
        </div>
