...
const slug = "super-joker";
const demoUrl = getDemoUrl(slug);
const displayName = "Super Joker";

export const metadata = {
  title: "Super Joker Slot 2026 — Review, RTP & Free Demo",
  description: "Play Super Joker free demo by Pragmatic Play. Retro fruit machine slot.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/super-joker/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/super-joker/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">A retro 3-reel slot with a joker theme. Classic fruit machine gameplay with a respin jackpot feature. Perfect for players who miss the traditional arcade slot experience.</p>
        </div>
        ...
        <div className="card-light mb-8">
          ...
          <div className="mt-4 space-y-2 text-sm text-slate-700">
            ...
            <p><strong>Theme:</strong> Classic Fruit</p>
          </div>
        </div>
