...
const slug = "power-of-torii";
const demoUrl = getDemoUrl(slug);
const displayName = "Power of Torii";

export const metadata = {
  title: "Power of Torii Slot 2026 — Review, RTP & Free Demo",
  description: "Play Power of Torii free demo by Pragmatic Play. Japanese-themed slot with free spins.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/power-of-torii/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/power-of-torii/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">A Japanese-themed 5x4 slot with 20 paylines. Torii gates trigger free spins with increasing multipliers. Max win 5,000x. The serene Japanese temple setting provides a relaxing gaming atmosphere.</p>
        </div>
        ...
        <div className="card-light mb-8">
          ...
          <div className="mt-4 space-y-2 text-sm text-slate-700">
            ...
            <p><strong>Theme:</strong> Japanese</p>
          </div>
        </div>
