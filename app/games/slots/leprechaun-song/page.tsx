...
const slug = "leprechaun-song";
const demoUrl = getDemoUrl(slug);
const displayName = "Leprechaun Song";

export const metadata = {
  title: "Leprechaun Song Slot 2026 — Review, RTP & Free Demo",
  description: "Play Leprechaun Song free demo by Pragmatic Play. Irish luck slot with free spins.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/leprechaun-song/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/leprechaun-song/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">An Irish luck themed 5x3 slot with 20 paylines. Rainbow free spins feature with sticky wilds and a max win of 3,000x. The cheerful Irish music and leprechaun theme create a fun atmosphere.</p>
        </div>
