...
const slug = "ultra-burn";
const demoUrl = getDemoUrl(slug);
const displayName = "Ultra Burn";

export const metadata = {
  title: "Ultra Burn Slot 2026 — Review, RTP & Free Demo",
  description: "Play Ultra Burn free demo by Pragmatic Play. Classic fruit machine.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/ultra-burn/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/ultra-burn/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">A classic fruit machine 3-reel slot with 5 paylines. Simple, fast-paced gameplay with win multipliers. The ultimate throwback for fans of traditional one-armed bandits.</p>
        </div>
