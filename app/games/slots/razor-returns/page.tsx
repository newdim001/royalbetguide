...
const slug = "razor-returns";
const demoUrl = getDemoUrl(slug);
const displayName = "Razor Returns";

export const metadata = {
  title: "Razor Returns Slot 2026 — Review, RTP & Free Demo",
  description: "Play Razor Returns free demo by Pragmatic Play. Shark-themed high-volatility slot.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/razor-returns/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/razor-returns/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">An underwater shark-themed high-volatility slot with 5 reels, 10 paylines, a money collect feature, and free spins with sticky wilds. Max win 10,000x. The razor-sharp graphics and intense gameplay create an exciting experience.</p>
        </div>
        ...
        <div className="card-light mb-8">
          ...
          <div className="mt-4 space-y-2 text-sm text-slate-700">
            ...
            <p><strong>Theme:</strong> Sharks</p>
          </div>
        </div>
