...
const slug = "dog-house-megaways";
const demoUrl = getDemoUrl(slug);
const displayName = "Dog House Megaways";

export const metadata = {
  title: "Dog House Megaways Slot 2026 — Review, RTP & Free Demo",
  description: "Play Dog House Megaways free demo by Pragmatic Play. Dog-themed Megaways slot with sticky wild multipliers.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/dog-house-megaways/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/dog-house-megaways/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">The beloved dog-themed slot gets the Megaways treatment with up to 86,436 ways to win. Features sticky wild multipliers during free spins and a max win of 7,850x. The increased ways to win make this version even more exciting than the original.</p>
        </div>
