...
const slug = "heist-stake";
const demoUrl = getDemoUrl(slug);
const displayName = "Heist Cash or Nothing";

export const metadata = {
  title: "Heist Cash or Nothing Slot 2026 — Review, RTP & Free Demo",
  description: "Play Heist Cash or Nothing free demo by Pragmatic Play. Casino heist money collect slot.",
  openGraph: {
    url: "https://royalbetguide.com/games/slots/heist-stake/",
  },
  alternates: { canonical: "https://royalbetguide.com/games/slots/heist-stake/" },
};
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <article>
        ...
        <div className="card-light mb-8">
          <p className="text-slate-700 leading-relaxed">A casino heist themed 5x3 slot with a money collect feature. Police chase bonus round with increasing multipliers. The thrilling heist narrative adds excitement to every spin.</p>
        </div>
