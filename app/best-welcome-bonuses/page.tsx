...
export const metadata = {
  ...
  description: "Claim the best casino welcome bonuses. Compare sign-up offers, free spins, and deposit matches.",
};
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
      <div className="mb-10 text-center">
        ...
        <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-corg-600">Best Welcome Bonuses 2026</h1>
        <p className="mt-2 text-slate-500">Claim the best casino welcome bonuses. Compare sign-up offers, free spins, and deposit matches.</p>
      </div>
