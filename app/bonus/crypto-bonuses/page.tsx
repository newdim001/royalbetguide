...
const ITEMS = [
    ...
    { name: "Stake", bonus: "Crypto Welcome Bonus", wagering: "0x", slug: "stake", imgSlug: "stake" },
    { name: "BC.Game", bonus: "Up to $20,000 + 200 FS", wagering: "35x", slug: "bc-game", imgSlug: "bc-game" },
  ];

export const metadata = {
  title: "Crypto Casino Bonuses 2026",
  description: "Claim exclusive crypto casino bonuses. Compare Bitcoin, Ethereum, and altcoin welcome offers at top crypto casinos.",
};

export default function CryptoBonusesPagePage() {
  return (
    <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
      <div className="mb-10 text-center">
        ...
        <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-corg-600">Crypto Bonuses</h1>
        <p className="mt-2 text-slate-500">Claim exclusive crypto casino bonuses. Compare Bitcoin, Ethereum, and altcoin welcome offers at top crypto casinos.</p>
      </div>
